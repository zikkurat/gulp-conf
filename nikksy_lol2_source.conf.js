...
<body>
	...
	<![CDATA[
		...
		var paths = {
			js: {
				src: ['../nikksy/lol2_source/**/*.js'],
				dest: '../nikksy/lol2/',
				map: '.'
			},
			html: {
				src: '../nikksy/lol2_source/*.html',
				dest: '../nikksy/lol2'
			},
			less: {
				watch: '../nikksy/lol2_source/**/*.less',
				src: '../nikksy/lol2_source/css/main.less',
				dest: '../nikksy/lol2/css'
			}
		};
		//}}}
		...
		gulp.task('html', function() {
			var head = gulp.src('../nikksy/lol2_source/template/head.html'),
				nav = gulp.src('../nikksy/lol2_source/template/nav.html'),
				google = gulp.src('../nikksy/lol2_source/template/google_code.html'),
				footer = gulp.src('../nikksy/lol2_source/template/footer.html');

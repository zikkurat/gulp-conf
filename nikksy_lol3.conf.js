...
<body>
	...
	<![CDATA[
		...
		var paths = {
			js: {
				src: ['../nikksy/lol3_source/**/*.js'],
				dest: '../nikksy/lol3/',
				src1: ['../nikksy/sign3_source/**/*.js'],
				dest1: '../nikksy/sign3/',
				map: '.'
			},
			html: {
				src: '../nikksy/lol3_source/*.html',
				dest: '../nikksy/lol3/',
				src1: '../nikksy/sign3_source/*.html',
				dest1: '../nikksy/sign3/'
			},
			less: {
				watch: '../nikksy/lol3_source/**/*.less',
				src: '../nikksy/lol3_source/css/main.less',
				dest: '../nikksy/lol3/css/',
				watch1: '../nikksy/sign3_source/**/*.less',
				src1: '../nikksy/sign3_source/css/main.less',
				dest1: '../nikksy/sign3/css/'
			}
		};
		//}}}
		...
		gulp.task('html', function() {
			var head = gulp.src('../nikksy/sign3_source/template/head.html'),
				nav = gulp.src('../nikksy/sign3_source/template/nav.html'),
				google = gulp.src('../nikksy/sign3_source/template/google_code.html'),
				footer = gulp.src('../nikksy/sign3_source/template/footer.html');

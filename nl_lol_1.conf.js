...
<body>
	<caption>联赛第一季归档(nl_lol/1_source/) target(nl_lol/1/)</caption>
	<content>
	<![CDATA[
		// 载入插件 {{{
		...
		var paths = {
			js: {
				src: ['../nikksy/nl_lol/1_source/**/*.js'],
				dest: '../nikksy/nl_lol/1/',
				map: '.'
			},
			html: {
				src: '../nikksy/nl_lol/1_source/*.html',
				dest: '../nikksy/nl_lol/1/'
			},
			less: {
				src: '../nikksy/nl_lol/1_source/**/*.less',
				dest: '../nikksy/nl_lol/1/'
			}
		};
		//}}}
